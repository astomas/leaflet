L.StreetView = L.Control.extend({
	...
	tabServices: [ 	
	['googleSV', 'StreetView', 'Street View', false, 'https://www.google.com/maps?layer=c&cbll={lat},{lon}', 'url("/Ressources/API_JS/images/icones visu/pegman.png")', '1px solid #717D7E'],	
