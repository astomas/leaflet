...
(function (factory) {
  ...
  L.Control.Search = L.Control.extend({
    ...
    options: {
      ...
      textErr: 'Elément non trouvé', // error message
      textCancel: 'Annuler', // title in cancel button
      textPlaceholder: 'Chercher élément', // placeholder value
    ...
    setLayer: function (layer) { // set search layer at runtime
      ...
      this._layer = layer
	  // modif cd30 couche rech. decochée à ouverture
	...
	// modif TF - ne pas cocher/afficher la couche entiere lors d'une recherche 
	showFeatureOnly: function (layer) {
	  if (!this._map.hasLayer(layer)) {
		layer.addTo(this._map);
		layer._addedBySearch = true;
	  }
	  return this;
	},

	hideFeatureOnly: function (layer) {
	  if (layer._addedBySearch) {
		this._map.removeLayer(layer);
		layer._addedBySearch = false;
	  }
	  return this;
	}
