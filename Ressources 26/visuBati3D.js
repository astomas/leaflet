...
// Code identique sur toutes les cartes. Appelé via le stub (le test du titre "...3D" reste
// dans le HTML car libelleCouche est une variable locale à dessinerCarte, donc le stub ne
// doit évaluer ses arguments que lorsque la 3D est réellement active) :
//   this.visuBatiments3D = function () {
//     if (valeurTitre1.endsWith("3D")) { window.visuBati3D(maCarte, tabCoucheMetier, libelleCouche); }
//   };
// Dépendances globales : L (Leaflet) et OSMBuildings (OSMBuildings-leaflet.js).
// Dépendances passées en paramètres :
...
window.visuBati3D = function (maCarte, tabCoucheMetier, libelleCouche) {
