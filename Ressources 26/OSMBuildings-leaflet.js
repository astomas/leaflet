(function (ba) {
    ...
    function ua(a) {
        ...
        var c,
            ...
            f = -Infinity;
        for (c = 0; c < b - 1; c += 2)
            (d = Math.min(d, a[c])), (e = Math.max(e, a[c])), (g = Math.min(g, a[c + 1])), (f = Math.max(f, a[c + 1]));
        c = e - d;
        f -= g;
        e = c / f;
        ...
        g = c * c;
        for (c = 0; c < b - 1; c += 2)
            if (((f = Q({ x: a[c], y: a[c + 1] }, d)), 0.8 > f / g || 1.2 < f / g)) return !1;
        return !0;
    }
    function ia(a, b) {
        var c = {};
        ...
        Y ||
            (Y = setInterval(function () {
                for (var a = E.items, b = !1, c = 0, d = a.length; c < d; c++)
                    1 > a[c].scale && ((a[c].scale += 0.1), 1 < a[c].scale && (a[c].scale = 1), (b = !0));
                A.render();
    ...
    var Da = (function () {
        ...
        Fa = (function () {
            ...
            function b(a, b) {
                ...
                for (n = a.length - 3; r < n; r += 2)
                    (c = a[r]), (d = a[r + 1]), (e = a[r + 2]), (m = a[r + 3]), (q += c * m - e * d);
            ...
            function c(a) {
                ...
                switch (a.type) {
                    case "GeometryCollection":
                        h = [];
                        d = 0;
                        for (e = a.geometries.length; d < e; d++) (l = c(a.geometries[d])) && h.push.apply(h, l);
                        return h;
                    case "MultiPolygon":
                        h = [];
                        d = 0;
                        for (e = a.coordinates.length; d < e; d++)
                            (l = c({ type: "Polygon", coordinates: a.coordinates[d] })) && h.push.apply(h, l);
                        return h;
                    case "Polygon":
                        a = a.coordinates;
                        break;
                ...
                read: function (b) {
                    ...
                    for (e = b.length; d < e; d++)
                        if (((q = b[d]), "Feature" === q.type && !1 !== sa(q))) {
                            ...
                            if ((r = h.material ? a(h.material) : h.wallColor || h.color)) l.wallColor = r;
                            if ((r = h.roofMaterial ? a(h.roofMaterial) : h.roofColor)) l.roofColor = r;
                            switch (h.shape) {
                                case "cylinder":
                                case "cone":
                                case "dome":
                            ...
                            l.roofShape && h.roofHeight
                                ? ((l.roofHeight = h.roofHeight), (l.height = I(0, l.height - l.roofHeight)))
                                : (l.roofHeight = 0);
                            n = l;
                            r = c(q.geometry);
                            h = 0;
                            for (l = r.length; h < l; h++) {
                                ...
                                if (p.isRotational) {
                                    for (
                                        var w = p, v = p.footprint, t = 180, u = -180, x = 0, y = v.length;
                                        x < y;
                                        x += 2
                                    )
                ...
                if (b[a]) g && g(b[a]);
                    ...
                    f.onreadystatechange = function () {
                        if (
                            ...
                            d += k.length;
                            for (g(k); 5242880 < d; ) (k = c.shift()), (d -= k.size), delete b[k.url];
                        }
                    };
                    f.open("GET", a);
                    f.send(null);
        ...
        E = {
            ...
            addRenderItems: function (a, b) {
                for (var c, d, e, g = Fa.read(a), f = 0, k = g.length; f < k; f++)
                    (c = g[f]),
                        ...
                        !this.loadedItems[e] &&
                            (d = this.scale(c)) &&
                            ((d.scale = b ? 0 : 1), this.items.push(d), (this.loadedItems[e] = 1));
                za();
            },
            scale: function (a) {
                var b = {},
                ...
                if (!(b.minHeight > fa) && ((b.footprint = this.getPixelFootprint(a.footprint)), b.footprint)) {
                    for (
                        var d = b.footprint,
                            e = Infinity,
                            g = -Infinity,
                        ...
                        (e = S(e, d[h])), (g = I(g, d[h])), (f = S(f, d[h + 1])), (k = I(k, d[h + 1]));
                    ...
                    a.wallColor &&
                        ...
                        ((q = q.alpha(C)), (b.altColor = "" + q.lightness(0.8)), (b.wallColor = "" + q));
            ...
            load: function (a, b) {
                this.src =
                    a ||
                    "https://{s}.data.osmbuildings.org/0.2/{k}/tile/{z}/{x}/{y}.json".replace("{k}", b || "anonymous");
                this.update();
            },
            update: function () {
                function a(a) {
                ...
                if (!(15 > x))
                    if (this.isStatic && this._staticData) this.addRenderItems(this._staticData);
                        ...
                        var b = 16 < x ? 256 << (x - 16) : 256 >> (16 - x),
                            ...
                            g,
                            f = this;
                        for (g = d; g <= b; g++) for (d = c; d <= e; d++) this.loadTile(d, g, 16, a);
                    }
            },
        ...
        X = {
            draw: function (a, b, c, d, e, g, f, k) {
                var h,
                    ...
                    m = [];
                if (c) for (b = 0, h = c.length; b < h; b++) m[b] = this._extrude(a, c[b], d, e, g, f);
                a.fillStyle = k;
                a.beginPath();
                this._ring(a, l);
                ...
                for (
                    ...
                    (k.x = b[r] - n),
                        ...
                        (h.x - k.x) * (l.y - k.y) > (l.x - k.x) * (h.y - k.y) &&
                            ((a.fillStyle = (k.x < h.x && k.y < h.y) || (k.x > h.x && k.y > h.y) ? g : e),
                            a.beginPath(),
            ...
            _ring: function (a, b) {
                a.moveTo(b[0], b[1]);
                for (var c = 2, d = b.length - 1; c < d; c += 2) a.lineTo(b[c], b[c + 1]);
            },
            ...
            _ringAbs: function (a, b) {
                ...
                for (var c = 2, d = b.length - 1; c < d; c += 2) a.lineTo(b[c] - n, b[c + 1] - p);
            },
            shadow: function (a, b, c, d, e) {
                for (var g = null, f = { x: 0, y: 0 }, k = { x: 0, y: 0 }, h, l, m = 0, q = b.length - 3; m < q; m += 2)
                    (f.x = b[m] - n),
                        (f.y = b[m + 1] - p),
                        (k.x = b[m + 2] - n),
                        (k.y = b[m + 3] - p),
                        ...
                        (k.x - f.x) * (h.y - f.y) > (h.x - f.x) * (k.y - f.y)
                            ? (1 === g && a.lineTo(f.x, f.y), (g = 0), m || a.moveTo(f.x, f.y), a.lineTo(k.x, k.y))
                            : (0 === g && a.lineTo(h.x, h.y), (g = 1), m || a.moveTo(h.x, h.y), a.lineTo(l.x, l.y));
                ...
                for (var m = 0, q = b.length - 3; m < q; m += 2)
                    (f.x = b[m] - n),
                        ...
                        (k.x - f.x) * (g.y - f.y) > (g.x - f.x) * (k.y - f.y)
                            ? (1 === c && a.lineTo(f.x, f.y), (c = 0), m || a.moveTo(f.x, f.y), a.lineTo(k.x, k.y))
                            : (0 === c && a.lineTo(g.x, g.y), (c = 1), m || a.moveTo(g.x, g.y), a.lineTo(l.x, l.y));
                a.closePath();
                a.fill();
            },
        },
        t = {
            draw: function (a, b, c, d, e, g, f, k, h) {
                ...
                (l = this._tangents(b, c, e, d))
                    ? ((g = N(l[0].y1 - b.y, l[0].x1 - b.x)), (l = N(l[1].y1 - b.y, l[1].x1 - b.x)))
                    : ((g = 1.5 * D), (l = 1.5 * D));
                a.fillStyle = f;
                a.beginPath();
                ...
                for (var h = { x: 0, y: 0 }, l = 0, m = b.length - 3; l < m; l += 2)
                    (d.x = b[l] - n),
                        ...
                        (h.x - d.x) * (c.y - d.y) > (c.x - d.x) * (h.y - d.y) &&
                            ((a.fillStyle = (d.x < h.x && d.y < h.y) || (d.x > h.x && d.y > h.y) ? f : g),
                            a.beginPath(),
                        ...
                        if (((b = l[m]), !ha.isSimple(b) && ((g = b.footprint), T(g)))) {
                            ...
                            switch (b.roofShape) {
                                ...
                                case "dome":
                                    ...
                                    break;
                                case "pyramid":
                                    P.draw(a, g, b.center, c + b.roofHeight, c, h, F.parse(h).lightness(0.9));
                            }
                        }
                }
            },
            ...
            render: function () {
                ...
                if (!(15 > x || O || x > this.maxZoom))
                    for (var b, c, d = E.items, e = 0, g = d.length; e < g; e++)
                        if (((b = d[e]), !(b.height >= this.maxHeight) && ((c = b.footprint), T(c))))
                            switch (((a.strokeStyle = b.altColor || Z), (a.fillStyle = b.roofColor || V), b.shape)) {
                                case "cylinder":
                                case "cone":
                                case "dome":
                                case "sphere":
            ...
            render: function () {
                ...
                if (
                    !(
                        ...
                        15 > x ||
                        O ||
                        ((b = ia(U + n, ea + p)), (b = Da(this.date, b.latitude, b.longitude)), 0 >= b.altitude)
                    )
                ) {
                    c = 1 / ja(b.altitude);
                    d = 5 > c ? 0.75 : (1 / c) * 5;
    ...
    w.onAdd = function (a) {
        ...
        a.attributionControl &&
            a.attributionControl.addAttribution('&copy; <a href="https://osmbuildings.org">OSM Buildings</a>');
        E.update();
    };
    w.onRemove = function () {
        var a = this.map;
        a.attributionControl &&
            a.attributionControl.removeAttribution('&copy; <a href="https://osmbuildings.org">OSM Buildings</a>');
        a.off(
            {
                move: this.onMove,
                moveend: this.onMoveEnd,
