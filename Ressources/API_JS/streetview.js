L.StreetView = L.Control.extend({
	...
	['IGN3D', 'IGN 3D', 'Géoportail IGN 3D', false,'https://www.geoportail.gouv.fr/carte?c={lon},{lat}&z=17&l3=ORTHOIMAGERY.ORTHOPHOTOS::GEOPORTAIL:OGC:WMTS(1)&l4=GEOGRAPHICALGRIDSYSTEMS.PLANIGNV2::GEOPORTAIL:OGC:WMTS(1;h)&l5=CADASTRALPARCELS.PARCELLAIRE_EXPRESS::GEOPORTAIL:OGC:WMTS(1;h)&l6=COMMUNES.PRIORITYDISCTRICT::GEOPORTAIL:OGC:WMTS(0.6;h)&l7=TRANSPORTNETWORKS.ROADS::GEOPORTAIL:OGC:WMTS(1)&l8=UTILITYANDGOVERNMENTALSERVICES.IGN.POI.ENSEIGNEMENTSECONDAIRE::GEOPORTAIL:OGC:WMS(1)&l9=TRANSPORTNETWORK.COMMONTRANSPORTELEMENTS.MARKERPOST_VISU::GEOPORTAIL:OGC:WMTS(1)&tilt=45&heading=0&is3Dloaded=yes&permalink=yes', 'url("/leaflet/Ressources/API_JS/images/icones visu/ign3d.png")', '1px solid #717D7E'],
