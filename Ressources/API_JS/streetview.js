L.StreetView = L.Control.extend({
	...
	['IGN3D', 'IGN 3D', 'Géoportail IGN 3D', false,'https://www.geoportail.gouv.fr/carte?c={lon},{lat}&z=17&l3=ORTHOIMAGERY.ORTHOPHOTOS::GEOPORTAIL:OGC:WMTS(1)&l4=GEOGRAPHICALGRIDSYSTEMS.PLANIGNV2::GEOPORTAIL:OGC:WMTS(1;h)&l5=CADASTRALPARCELS.PARCELLAIRE_EXPRESS::GEOPORTAIL:OGC:WMTS(1;h)&l6=COMMUNES.PRIORITYDISCTRICT::GEOPORTAIL:OGC:WMTS(0.6;h)&l7=TRANSPORTNETWORKS.ROADS::GEOPORTAIL:OGC:WMTS(1)&l8=UTILITYANDGOVERNMENTALSERVICES.IGN.POI.ENSEIGNEMENTSECONDAIRE::GEOPORTAIL:OGC:WMS(1)&l9=TRANSPORTNETWORK.COMMONTRANSPORTELEMENTS.MARKERPOST_VISU::GEOPORTAIL:OGC:WMTS(1)&tilt=45&heading=0&is3Dloaded=yes&permalink=yes', 'url("/Ressources/API_JS/images/icones visu/ign3d.png")', '1px solid #717D7E'],	
	...
	// Au 04/24 on peut juste forcer le basemap sat, pas la 3D
	['googlemap3D', 'Google Map 3D', 'Google Maps 3D', false, 'https://www.google.com/maps/place/{lat},{lng}/@{lat},{lng},51a,35y,39.61t/data=!3m1!1e3?entry=ttu', 'url("/Ressources/API_JS/images/icones visu/gmap3D.png")', '1px solid #717D7E'],	
	['googleearth', 'Google Earth 3D', 'Google Earth 3D', false, 'https://earth.google.com/web/@{lat},{lon},35y,0h,300d,750a,50t,0r', 'url("/Ressources/API_JS/images/icones visu/google_earth.png")', '1px solid #717D7E'],
